    ...
    (function () {
      ...
      var u = "top",
        ...
        T = y.reduce(function (t, e) {
          return t.concat([e + "-" + _, e + "-" + k]);
        }, []),
        j = [].concat(y, [w]).reduce(function (t, e) {
          return t.concat([e, e + "-" + _, e + "-" + k]);
        }, []),
        O = "beforeRead",
        L = "read",
        S = "afterRead",
      ...
      function Z(t, e, r) {
        ...
        var n = (F(t) ? H(t) : window).visualViewport,
          s = !G() && r,
      ...
      function at(t) {
        return W(t) && "fixed" !== et(t).position ? t.offsetParent : null;
      }
      function nt(t) {
        for (
          var e = H(t), r = at(t);
          r && rt(r) && "static" === et(r).position;

        )
          r = at(r);
        return r &&
          ("html" === R(r) || ("body" === R(r) && "static" === et(r).position))
          ? e
          : r ||
              (function (t) {
                var e = /firefox/i.test(Q());
                if (/Trident/i.test(Q()) && W(t) && "fixed" === et(t).position)
                  return null;
                var r = it(t);
                for (
                  q(r) && (r = r.host);
      ...
      var pt = {
        ...
        fn: function (t) {
          var e,
            ...
            s = X(r.placement),
            l = st(s),
            d = [x, v].indexOf(s) >= 0 ? "height" : "width";
          if (a && n) {
            var m = (function (t, e) {
                return dt(
                  "number" !=
      ...
      function gt(t) {
        var e,
          ...
          g = n.y,
          f = void 0 === g ? 0 : g,
          w = "function" == typeof m ? m({ x: b, y: f }) : { x: b, y: f };
        (b = w.x), (f = w.y);
        var y = n.hasOwnProperty("x"),
          _ = n.hasOwnProperty("y"),
          z = x,
          A = u,
          E = window;
        if (d) {
        ...
        var O,
          L = Object.assign({ position: s }, d && bt),
          S =
            !0 === m
              ? (function (t, e) {
                  var r = t.x,
      ...
      function Et(t, e) {
        ...
        var o = At(t),
          ...
          a = H(o),
          n = i ? [a].concat(a.visualViewport || [], zt(o) ? o : []) : o,
          s = e.concat(n);
        ...
        return e === A
          ? Ct(
              (function (t, e) {
                ...
                return { width: a, height: n, x: s + kt(t), y: l };
              })(t, r)
            )
          : F(e)
          ? (function (t, e) {
      ...
      function Ot(t, e) {
        ...
        if (c === E && $) {
          var M = $[i];
          Object.keys(I).forEach(function (t) {
            var e = [v, h].indexOf(t) >= 0 ? 1 : -1,
              r = [u, h].indexOf(t) >= 0 ? "y" : "x";
            I[t] += M[r] * e;
          });
        }
        return I;
              ...
              var i = r.mainAxis,
                ...
                A =
                  ...
                  (z !== k && g
                    ...
                    : [xt(k)]),
                E = [k].concat(A).reduce(function (t, r) {
                  return t.concat(
                    X(r) === w
                      ? (function (t, e) {
                          void 0 === e && (e = {});
      ...
      function Dt(t) {
        return [u, v, h, x].some(function (e) {
          return t[e] >= 0;
        });
      }
      var It = {
          ...
          fn: function (t) {
            var e = t.state,
              ...
              n = Ot(e, { elementContext: "reference" }),
        ...
        $t = {
          ...
          fn: function (t) {
            var e = t.state,
              ...
              i = r.offset,
              a = void 0 === i ? [0, 0] : i,
              n = j.reduce(function (t, r) {
                return (
                  (t[r] = (function (t, e, r) {
                    var o = X(t),
                      i = [x, u].indexOf(o) >= 0 ? -1 : 1,
                      a =
                        "function" == typeof r
              ...
              if (a) {
                var I,
                  ...
                  et = z
                    ...
                    : W + Z + G + L.mainAxis,
                  rt = e.elements.arrow && nt(e.elements.arrow),
                  ot = rt
                    ? "y" === A
                      ? rt.clientTop || 0
                      : rt.clientLeft || 0
                  ...
                  at = P + et - it,
                  dt = lt(b ? V(B, P + tt - it - ot) : B, P, b ? Y(R, at) : R);
                (C[A] = dt), (D[A] = dt - P);
              }
              if (s) {
                var mt,
                  ...
                  wt = vt ? ut : gt - T[ft] - j[ft] - xt + L.altAxis,
                  yt = vt ? gt + T[ft] + j[ft] - xt - L.altAxis : ht,
                  _t =
                    b && vt
                      ? (function (t, e, r) {
                          var o = lt(t, e, r);
            ...
            m = {
              ...
              forceUpdate: function () {
                if (!d) {
                  ...
                  if (Ht(e, r)) {
                    (s.rects = {
                      reference: Pt(e, nt(r), "fixed" === s.options.strategy),
                      popper: J(r),
                    }),
                      (s.reset = !1),
      ...
      var Wt = Ft(),
        qt = Ft({ defaultModifiers: [ht, Mt, ft, U, $t, Lt, Nt, pt, It] }),
        Ut = Ft({ defaultModifiers: [ht, Mt, ft, U] });
      const Xt = "transitionend",
        ...
        Zt = (t) =>
          Gt(t)
            ...
            : null,
        Jt = (t) => {
          if (!Gt(t) || 0 === t.getClientRects().length) return !1;
          const e =
      ...
      const Te = new Map(),
        je = {
          ...
          get(t, e) {
            return (Te.has(t) && Te.get(t).get(e)) || null;
          },
          remove(t, e) {
            if (!Te.has(t)) return;
            const r = Te.get(t);
            r.delete(e), 0 === r.size && Te.delete(t);
          },
        };
      function Oe(t) {
        if ("true" === t) return !0;
      ...
      const Se = {
        ...
        getDataAttribute(t, e) {
          return Oe(t.getAttribute(`data-bs-${Le(e)}`));
        },
      };
      class De {
        static get Default() {
      ...
      class wr extends Ie {
        ...
        _slide(t, e = null) {
          ...
          const r = this._getActive(),
            o = t === tr,
            i = e || me(this._getItems(), r, o, this._config.wrap);
          if (i === r) return;
      ...
      Ee.on(document, pr, "[data-bs-slide], [data-bs-slide-to]", function (t) {
        ...
        return o
          ...
          : "next" === Se.getDataAttribute(this, "slide")
      ...
      const yr = ".bs.collapse",
        ...
        zr = `hide${yr}`,
        Ar = `hidden${yr}`,
        Er = `click${yr}.data-api`,
        Cr = "show",
        Tr = "collapse",
        jr = "collapsing",
        Or = `:scope .${Tr} .${Tr}`,
        Lr = '[data-bs-toggle="collapse"]',
        Sr = { parent: null, toggle: !0 },
        Dr = { parent: "(null|element)", toggle: "boolean" };
      class Ir extends Ie {
        constructor(t, e) {
      ...
      const $r = "dropdown",
        ...
        Kr = `${Vr}.${Yr}`,
        Qr = ".dropdown-menu",
        Gr = ne() ? "top-end" : "top-start",
        Zr = ne() ? "top-start" : "top-end",
        Jr = ne() ? "bottom-end" : "bottom-start",
        to = ne() ? "bottom-start" : "bottom-end",
        eo = ne() ? "left-start" : "right-start",
        ro = ne() ? "right-start" : "left-start",
        oo = {
          autoClose: !0,
      ...
      const Ao = ".bs.modal",
        ...
        Lo = `resize${Ao}`,
        So = `click.dismiss${Ao}`,
        Do = `mousedown.dismiss${Ao}`,
        Io = `keydown.dismiss${Ao}`,
        $o = `click${Ao}.data-api`,
        Mo = "modal-open",
        No = "show",
        Po = "modal-static",
          ...
          for (const e of t)
            if ("click" === e)
              ...
              Ee.on(this._element, t, this._config.selector, (t) => {
                ...
                (e._activeTrigger["focusin" === t.type ? yi : wi] = !0),
                  e._enter();
              }),
                Ee.on(this._element, r, this._config.selector, (t) => {
                  const e = this._initializeOnDelegatedTarget(t);
                  (e._activeTrigger["focusout" === t.type ? yi : wi] =
      ...
      const Ei = {
        ...
        Ci = { ...Ai.DefaultType, content: "(null|string|element|function)" };
      class Ti extends Ai {
        static get Default() {
          return Ei;
        }
      ...
      const ji = ".bs.scrollspy",
        ...
        Ii = "[href]",
        $i = ".nav-link",
        Mi = `${$i}, .nav-item > ${$i}, .list-group-item`,
        Ni = {
          offset: null,
      ...
      const Ri = ".bs.tab",
        ...
        Ji = "fade",
        ta = "show",
        ea = ":not(.dropdown-toggle)",
        ra =
          '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
        oa = `.nav-link${ea}, .list-group-item${ea}, [role="tab"]${ea}, ${ra}`,
        ia = `.${Zi}[data-bs-toggle="tab"], .${Zi}[data-bs-toggle="pill"], .${Zi}[data-bs-toggle="list"]`;
      class aa extends Ie {
        constructor(t) {
          super(t),
        ...
        show() {
          ...
          const e = this._getActiveElem(),
            r = e ? Ee.trigger(e, Hi, { relatedTarget: t }) : null;
      ...
      const na = ".bs.toast",
        ...
        ua = "show",
        ha = "showing",
        va = { animation: "boolean", autohide: "boolean", delay: "number" },
